...
#define cpu_map_h
  ...
  #endif
  #define MIN_LIMIT_BIT_0 4 // X Limit Min - Pin D45
  #define MIN_LIMIT_BIT_1 2 // Y Limit Min - Pin D39
  #define MIN_LIMIT_BIT_2 5 // Z Limit Min - Pin D4
  #if N_AXIS > 3
  ...
  #if N_AXIS > 3
    #define MAX_LIMIT_BIT_3 1 // Axis number 4 : RAMPS pin D14
  #endif
  #if N_AXIS > 4
    #define MAX_LIMIT_BIT_4 5 // Axis number 5 : RAMPS pin D3
  #endif
  #if N_AXIS > 5
  ...
  #define SPINDLE_ENABLE_BIT      4 // MEGA2560 Analog Pin 4 - Ramps 1.4 Servo 4 Signal pin (A4)
  #define SPINDLE_DIRECTION_DDR   DDRF
  #define SPINDLE_DIRECTION_PORT  PORTF
  #define SPINDLE_DIRECTION_BIT   3 // MEGA2560 Analog Pin 3 - Ramps 1.4 Servo 3 Signal pin (A3)
  ...
  // D16 D17 D23 D25
  #define DIGITAL_OUTPUT_DDR_0  DDRE
  #define DIGITAL_OUTPUT_PORT_0 PORTE
  #define DIGITAL_OUTPUT_BIT_0  3 // MEGA2560 Digital Pin 4 - Ramps 1.4 AUX-4 D4
  #define DIGITAL_OUTPUT_DDR_1  DDRL
  #define DIGITAL_OUTPUT_PORT_1 PORTL
  #define DIGITAL_OUTPUT_BIT_1  6 // MEGA2560 Digital Pin 43 - Ramps 1.4 AUX-4 D43
  #define DIGITAL_OUTPUT_DDR_2  DDRL
  #define DIGITAL_OUTPUT_PORT_2 PORTL
  #define DIGITAL_OUTPUT_BIT_2  2 // MEGA2560 Digital Pin 47 - Ramps 1.4 AUX-4 D47
  #define DIGITAL_OUTPUT_DDR_3  DDRC
  #define DIGITAL_OUTPUT_PORT_3 PORTC
  #define DIGITAL_OUTPUT_BIT_3  5 // MEGA2560 Digital Pin 32 - Ramps 1.4 AUX-4 D32
  ...
  #define CONTROL_RESET_BIT         7  // Pin A15 - RAMPS Aux 2 Port
  #define CONTROL_FEED_HOLD_BIT     6  // Pin A14 - RAMPS Aux 2 Port
  #define CONTROL_CYCLE_START_BIT   5  // Pin A13 - RAMPS Aux 2 Port
  ...
  #define PROBE_BIT       3  // MEGA2560 Pin D18
