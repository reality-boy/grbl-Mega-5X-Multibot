...
/* The defaults.h file serves as a central default settings selector for different machine
   ...
   NOTE: Ensure one and only one of these DEFAULTS_XXX values is defined in config.h */
    ...
    #define DEFAULT_AXIS1_MAX_RATE 2000.0 // 2000 mm/min = 2000/60 = 33 mm/sec
    //#define DEFAULT_AXIS1_MAX_RATE (STEP_MAX_FREQUENCY/DEFAULT_AXIS1_STEPS_PER_UNIT*SECONDS_PER_MINUTE) // 3000
    #define DEFAULT_AXIS2_MAX_RATE 2000.0 // 2000 mm/min = 2000/60 = 33 mm/sec
    //#define DEFAULT_AXIS2_MAX_RATE (STEP_MAX_FREQUENCY/DEFAULT_AXIS2_STEPS_PER_UNIT*SECONDS_PER_MINUTE)
    #define DEFAULT_AXIS3_MAX_RATE 2000.0  //  2000 mm/min =  2000/60 =  33 mm/sec
    //#define DEFAULT_AXIS3_MAX_RATE (STEP_MAX_FREQUENCY/DEFAULT_AXIS3_STEPS_PER_UNIT*SECONDS_PER_MINUTE)
    #define DEFAULT_AXIS1_ACCELERATION (40.0*60*60) // 300*60*60 mm/min^2 = 300 mm/sec^2
    #define DEFAULT_AXIS2_ACCELERATION (40.0*60*60) // 300*60*60 mm/min^2 = 300 mm/sec^2
    #define DEFAULT_AXIS3_ACCELERATION (40.0*60*60) // 100*60*60 mm/min^2 = 100 mm/sec^2
    #define DEFAULT_AXIS1_MAX_TRAVEL 365.0 // mm
    #define DEFAULT_AXIS2_MAX_TRAVEL 465.0 // mm
    #define DEFAULT_AXIS3_MAX_TRAVEL 75.0 // mm
    #if N_AXIS > 3
      #if AXIS_4_NAME != AXIS_1_NAME && AXIS_4_NAME != AXIS_2_NAME && AXIS_4_NAME != AXIS_3_NAME
        #define DEFAULT_AXIS4_STEPS_PER_UNIT 400.0 
        #define DEFAULT_AXIS4_MAX_RATE 2000 
        #define DEFAULT_AXIS4_ACCELERATION (40.0*60*60) // 100*60*60 mm/min^2 = 100 mm/sec^2
        #define DEFAULT_AXIS4_MAX_TRAVEL 465.0 
		...
		//****Note, 3x belt reduction * 200 steps per revolution * 16 microsteps == 9600 steps per rotation
		// But what is our 'unit', one degree, 15 degrees, 360 degrees.  Whatever we pick the movement
		// is not well synchronized with the other axis.
        #define DEFAULT_AXIS5_STEPS_PER_UNIT 26.67 // steps/deg
        #define DEFAULT_AXIS5_MAX_RATE 3600 // deg/min
        #define DEFAULT_AXIS5_ACCELERATION (10*60*60) // 10*60*60 deg/min^2 = 10 deg/sec^2
      ...
      #endif
    #endif
    #if N_AXIS > 5 //****Note, not used on MultiBot
